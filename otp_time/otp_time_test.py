...
twilio_auth_token = "2e6ae8b97573afd1d45ea2b542d96e0c"
twilio_phone_number = "+12055649437"
recipient_phone_number = "+919907524334"  # Replace with the recipient's phone number
...
while True:
    ...
    remaining_time = 60 - (current_time - start_time)
    if remaining_time <= 0:
        print("Time limit exceeded. Program terminated.")
        break

    # Prompt the user for input
    user_input = input(f"Enter the 6-character alphanumeric code (Time remaining: {int(remaining_time)} seconds): ")
