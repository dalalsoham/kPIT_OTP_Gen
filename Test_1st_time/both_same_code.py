...
# Generate a random code before entering the loop
...
try:
    with smtplib.SMTP_SSL(smtp_server, smtp_port) as server:
        ...
        for recipient_email in recipient_emails:
            ...
            # Use the same random code for both recipients
...
# Print the random code that was sent to both recipients
print(f"Random Code: {random_code}")

print("Random code matched")